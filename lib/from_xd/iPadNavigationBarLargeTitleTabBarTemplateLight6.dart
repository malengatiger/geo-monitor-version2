...
class iPadNavigationBarLargeTitleTabBarTemplateLight6 extends StatelessWidget {
  iPadNavigationBarLargeTitleTabBarTemplateLight6({
    Key? key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          Container(
            ...
            margin: EdgeInsets.fromLTRB(-162.0, -150.0, 0.0, -150.0),
          ),
          ClipRect(
