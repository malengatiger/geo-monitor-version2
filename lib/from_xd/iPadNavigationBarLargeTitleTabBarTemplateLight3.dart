...
class iPadNavigationBarLargeTitleTabBarTemplateLight3 extends StatelessWidget {
  iPadNavigationBarLargeTitleTabBarTemplateLight3({
    Key? key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          Container(
            ...
            margin: EdgeInsets.fromLTRB(-4.0, -12.0, -1.0, -53.0),
          ),
          ClipRect(
