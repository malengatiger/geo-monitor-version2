...
class iPadPro11in1 extends StatelessWidget {
  iPadPro11in1({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          ClipRect(
            child: BackdropFilter(
              ...
              child: Container(
                ...
                margin: EdgeInsets.fromLTRB(0.0, -33.0, 0.0, -446.0),
              ),
            ),
          ),
          Pinned.fromPins(
          ...
          Align(
            alignment: Alignment(-0.633, -0.49),
            child: SizedBox(
              width: 165.0,
              height: 46.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(-0.296, -0.49),
            child: SizedBox(
              width: 165.0,
              height: 46.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(-0.427, 0.024),
            child: SizedBox(
              width: 241.0,
              height: 211.0,
              child: Stack(
          ...
          Container(
            ...
            margin: EdgeInsets.fromLTRB(-172.0, -716.0, -32.0, -1480.0),
          ),
          Pinned.fromPins(
