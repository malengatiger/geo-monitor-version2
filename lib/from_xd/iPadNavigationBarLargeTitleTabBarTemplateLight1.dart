...
class iPadNavigationBarLargeTitleTabBarTemplateLight1 extends StatelessWidget {
  iPadNavigationBarLargeTitleTabBarTemplateLight1({
    Key? key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          Container(
            ...
            margin: EdgeInsets.fromLTRB(0.0, -179.0, 0.0, -778.0),
          ),
          ClipRect(
            child: BackdropFilter(
              ...
              child: Container(
                ...
                margin: EdgeInsets.fromLTRB(0.0, -33.0, 0.0, -420.0),
              ),
            ),
          ),
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: 0.0, start: -21.0),
                  Pin(size: 0.0, start: -25.0),
                  child: Stack(
                    children: <Widget>[],
                  ),
                ),
          ...
          Align(
            alignment: Alignment(-0.623, -0.49),
            child: SizedBox(
              width: 165.0,
              height: 46.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(-0.287, -0.49),
            child: SizedBox(
              width: 165.0,
              height: 46.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(0.386, -0.49),
            child: SizedBox(
              width: 165.0,
              height: 46.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(-0.417, 0.024),
            child: SizedBox(
              width: 241.0,
              height: 211.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(0.123, 0.024),
            child: SizedBox(
              width: 241.0,
              height: 211.0,
              child: Stack(
