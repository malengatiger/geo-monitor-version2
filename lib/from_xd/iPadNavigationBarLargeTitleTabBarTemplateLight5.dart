...
class iPadNavigationBarLargeTitleTabBarTemplateLight5 extends StatelessWidget {
  iPadNavigationBarLargeTitleTabBarTemplateLight5({
    Key? key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          Container(
            ...
            margin: EdgeInsets.fromLTRB(-312.0, -852.0, -122.0, 144.0),
          ),
          ClipRect(
