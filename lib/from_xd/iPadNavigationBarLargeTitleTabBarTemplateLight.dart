...
class iPadNavigationBarLargeTitleTabBarTemplateLight extends StatelessWidget {
  iPadNavigationBarLargeTitleTabBarTemplateLight({
    Key? key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          Container(
            ...
            margin: EdgeInsets.fromLTRB(-31.0, -558.0, -32.0, -493.0),
          ),
          ClipRect(
