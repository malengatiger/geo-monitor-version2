...
class RatingAdderMobileState extends State<RatingAdderMobile>
  ...
  void _checkMedia() {
    if (widget.videoId == null && widget.audioId == null && widget.photoId == null) {
  ...
  Widget build(BuildContext context) {
    return SafeArea(child: Scaffold(
      appBar: AppBar(
        title: Text('Project Rating', style: myTextStyleSmall(context),),
      ),
      body: Stack(
        children: [
          Positioned(
            left: 24, right: 24, top: 80, bottom: 80,
            child: Card(
            elevation: 4,
            ...
            child: Padding(
              ...
              child: Column(
                children:  [
                  ...
                  Text('${widget.project.name}', style: myTextStyleMediumBold(context),),
                  const SizedBox(height: 60,),
                RatingBar.builder(
                  initialRating: 1,
                  minRating: 1, maxRating: 5,
                  direction: Axis.horizontal,
                  allowHalfRating: true,itemSize: 40,glow: true, glowColor: Colors.teal,
                  glowRadius: 8,
                  itemCount: 5,
                  ...
                  ): TextButton(onPressed: _submitRating, child: const Text('Send Rating')),
                ],
              ),
            ),
          ),)
