...
class ProjectPhotosMobile extends StatefulWidget {
  ...
  const ProjectPhotosMobile({super.key, required this.project, required this.refresh, required this.onPhotoTapped});

  @override
  State<ProjectPhotosMobile> createState() => ProjectPhotosMobileState();
}

class ProjectPhotosMobileState extends State<ProjectPhotosMobile> with SingleTickerProviderStateMixin{
